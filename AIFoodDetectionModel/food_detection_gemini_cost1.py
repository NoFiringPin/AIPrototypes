...
def write_detections(image, food_names):
    """Write the detected food names and costs on the image, excluding bounding boxes."""
    ...
    cv2.putText(image, header_text, (width + 10, y_position), cv2.FONT_HERSHEY_SIMPLEX, font_scale * 1.2, (0, 0, 255), thickness)
    ...
    for i, food in enumerate(food_names):
        ...
        cv2.putText(image, label_text, (width + 10, y_position), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 0), thickness)
    ...
    cv2.putText(image, total_text, (width + 10, height - 30), cv2.FONT_HERSHEY_SIMPLEX, font_scale * 1.2, (0, 0, 255), thickness)
